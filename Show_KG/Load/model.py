...
from Show_KG.Load.data import pad_sequences, batch_yield
from Show_KG.Load.utils import get_logger
from Show_KG.Load.eval import conlleval
...
class BiLSTM_CRF(object):
    ...
    def evaluate(self, label_list, seq_len_list, data, epoch=None):
        ...
        if epoch_num == 'test':
            label_path = os.path.join('./my_data_path','label_test')
